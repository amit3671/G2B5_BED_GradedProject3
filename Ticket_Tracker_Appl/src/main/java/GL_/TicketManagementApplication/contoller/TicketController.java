...
public class TicketController {
	...
	public String search(Model model, @Param("title") String title, @Param("short_desc") String short_desc) {
		List<Tickets> listickets = ticketService.searchTicketBytitle(title, short_desc);
